...
public class Czynniki_pierwsze
{
    public static int[] Liczby_Pierwsze = new[]
    {
    ...
    public static string Czynniki_Pierwsze(int number)
    {
        string czynniki = string.Empty;

        foreach (int divisor in Liczby_Pierwsze)
        {
            int remainder;
            do
            {
